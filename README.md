...
- **Challenges** are DSDA-style categories on the shareware maps, tagged Beginner / Intermediate / Hard: NoMo (no monsters, the beginner tier) on E1M1, E1M2, E1M4, and E1M9; UV Speed and Pacifist on E1M1, E1M2, and E1M4; E1M3 to either exit; E1M9; and NM Speed, NM 100S, UV Max, and Tyson on E1M1. Each card shows the human world record for that map/category from [DSDA](https://dsdarchive.com/wads/doom) and links to its leaderboard. Only combinations a mortal can finish inside **2:00** are listed; the 2:00 limit is enforced.
...
- **Rules are judged by the engine**, not the page: Pacifist and Tyson watch `P_DamageMobj` for player-inflicted monster damage (barrels and telefrags exempt, per DSDA rules); Max/100S/Tyson compare kill and secret counts against the level totals at exit; the E1M3 challenges check which exit was taken. Dying, running out of time, or breaking a category rule ends the attempt. Vanilla cheat codes are compiled out.
