...
- **Gamepad**: a wired or Bluetooth Xbox-layout controller works alongside touch and keyboard, no setup needed — left stick to move/strafe, right stick to turn, RT to fire, A to use, Y to switch weapons, B to pause/back, Start to begin a challenge, Back/View to restart.
